  ...
  return (
    ...
    <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action='https://getform.io/f/1eadbbd4-8bc0-4e75-a0f7-06dc3e4bb0b4' method='POST' className='flex flex-col w-full md:w-1/2'> 
            <input type="text" name="Name" placeholder='Enter your Name'
             ...
             rounded-md hover:scale-110 duration-300'>Lets Talk</button>
